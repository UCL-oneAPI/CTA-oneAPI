...
int main(int argc, char *argv[]) try {
	...
	/* allocate the Memory in the GPU for SNP data */
        ...
        */
        ...
        /*
        CTA1000:3: Base on the experience, strongly recommended to ignore this warning.
        */
        if (err != 0) {
	...
	/*Copy the SNP data to GPU */
        ...
        /*
        CTA1000:5: Base on the experience, strongly recommended to ignore this warning.
        */
        if (err != 0) {
	...
	/*Calling the kernel function */
        ...
        /*
        CTA1000:7: Base on the experience, strongly recommended to ignore this warning.
        */
        if (err != 0) {
