...
if __name__ == '__main__':
    ...
    parser.add_argument('--mode', type=str,
                        help="This is used to select the mode you want CTA to run on, we provide you three mode to "
                             "use CTA system, the first one is default mode which will do the auto-fix and generate analysis "
                             "report, another mode is 'report_only' mode which will only generate the report for "
                             "analysis, the last mode is 'training_analysis_report' mode, this will generate the "
                             "report for the traning data for CTA which will help other developers to better explore "
                             "the other potential aspects to improve CTA system",
    ...
    parser.add_argument('--project-path', type=str, action='store',
                        help='this is the project path you want to run CTA on, you can enter relative path to CTA '
                             'root path or you can enter the absolute path.')
